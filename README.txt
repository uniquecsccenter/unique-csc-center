...
UPDATED FLOW
- Home link always returns to the front/hero section: index.html#digital
- All Services opens a separate services.html page
- Exactly 100 online service entries are included
...
- Passport Seva: fee pages currently note revised passport application fees effective 1 July 2026 and advise checking the current fee calculator.
- PM-KISAN: the current new farmer registration form shows Aadhaar authentication as part of registration.
...
services.html
style.css
script.js (legacy file retained from supplied version)
services.js
services-data.js
logo.svg
README.txt

Open index.html in a browser or upload the complete folder to hosting.
